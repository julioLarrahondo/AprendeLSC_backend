...
model = TFSMLayer("modelos/Numeros/numeros_lsc", call_endpoint="serving_default")
with open("modelos/Numeros/numeros.pkl", "rb") as f:
    le = pickle.load(f)
...
# === Limpieza automática por sesión ===
...
@app.route('/')
def index():
    return "✅ Servidor de lenguaje de señas para NÚMEROS corriendo correctamente."
